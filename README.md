...
* Create symbolic links: 
  ...
  - Aadd personal colorscheme which appears to be optimal for working during the night (inspired from hybrid_reverse from [vim-hybrid-material](https://github.com/kristijanhusak/vim-hybrid-material)) `cd && ln -s $VIMRUNTIME/colors/new_york_mac.vim $HOME/codes/vim/colorscheme/new_york_mac.vim` color theme for mac come with a higher contrast due to retina screens.
